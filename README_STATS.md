...
![Last Sync](https://img.shields.io/badge/Last_Sync-2026-02-20_23-34-40-blue?style=for-the-badge&logo=cloudflare&logoColor=white)
...
![Runtime](https://img.shields.io/badge/Runtime-90.71s-lightgrey?style=for-the-badge&logo=lightning&logoColor=white)
...
| ⏱️ | **Sync Runtime** | `90.71s` | wall clock |
...
xychart-beta horizontal
    ...
    y-axis "Domains"
    bar [186, 10291, 13751, 196727, 34014]
    line [186, 10291, 13751, 196727, 34014]
```
...
xychart-beta
    ...
    x-axis ['"sex"', '"porn"', '"xxx"', '"hentai"', '"xnxx"', '"milf"', '"fuck"', '"xvideo"', '"erotic"', '"bdsm"']
    y-axis "Blocked Domains"
    bar [10290, 8751, 3268, 698, 574, 526, 495, 425, 423, 261]
```
...
*Auto-generated · `2026-02-20 23:34:40` · [sync_blocklist.py](./sync_blocklist.py)*
