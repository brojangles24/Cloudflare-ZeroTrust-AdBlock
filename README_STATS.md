...
![Last Sync](https://img.shields.io/badge/Last_Sync-2026-02-20_17-12-23-blue?style=for-the-badge&logo=cloudflare&logoColor=white)
![Active Rules](https://img.shields.io/badge/Active_Rules-252,959-success?style=for-the-badge&logo=shield&logoColor=white)
![Quota](https://img.shields.io/badge/Quota-84.32%25-critical?style=for-the-badge)
![Runtime](https://img.shields.io/badge/Runtime-92.24s-lightgrey?style=for-the-badge&logo=lightning&logoColor=white)
...
| 📥 | **Raw Domains Fetched** | `310,040` | before any filtering |
| ✅ | **Active Block Rules** | `252,959` | pushed to Cloudflare |
| 🧹 | **Total Filtered Out** | `57,081` | noise removed |
| 🔁 | **Duplicates Removed** | `753` | cross-source overlap |
| 🌳 | **Subdomains Tree-Pruned** | `1,048` | covered by parent rule |
| ⏱️ | **Sync Runtime** | `92.24s` | wall clock |
...
> From **310,040 raw domains** down to **252,959 precision block rules** — a 18.4% reduction in noise.

```mermaid
pie showData title DNS Blocklist Pipeline Breakdown
    "Active Rules"     : 252959
    "Keyword Filtered" : 27068
    "Banned TLD"       : 27908
    "Deduplication"    : 753
    "Tree Pruned"      : 1048
```
...
timeline
    ...
    section Ingest
        Concurrent Fetch   : 5 sources
                           : 310,040 raw domains
    section Filter
        Keyword Offload    : -27,068 domains
        TLD Blocklist      : -27,908 domains
        Deduplication      : -753 duplicates
    section Optimise
        Subdomain Tree Prune : -1,048 subdomains
        Final Domain Pool    : 252,959 unique rules
    section Deploy
...
| :--- | ---: | ---: | :--- |
| 🔴 Keyword Filtered  | 27,068  | 8.73%  | `██░░░░░░░░░░░░░░░░░░░░░░░░░░  8.7%` |
| 🟠 Banned TLD        | 27,908 | 9.0% | `███░░░░░░░░░░░░░░░░░░░░░░░░░  9.0%` |
| 🟡 Dedup + Tree Prune | 1,801 | 0.58% | `░░░░░░░░░░░░░░░░░░░░░░░░░░░░  0.6%` |
| 🟢 **Active Rules**  | **252,959** | **81.59%** | `███████████████████████░░░░░  81.6%` |
...
xychart-beta horizontal
    ...
    y-axis "Domains"
    bar [186, 13751, 10291, 33999, 196533]
    line [186, 13751, 10291, 33999, 196533]
```
...
| :--- | ---: | ---: | ---: | :--- | :---: |
| HaGeZi Pro++ |    218,108 |    196,533 |   196,533 | `████████████████  100.0%` | 🥇 |
| Hagezi NSFW |     66,045 |     33,999 |    33,999 | `████████████████  100.0%` | 🥈 |
...
xychart-beta
    ...
    x-axis ['"sex"', '"porn"', '"xxx"', '"hentai"', '"xvideo"', '"xnxx"', '"milf"', '"fuck"', '"erotic"', '"bdsm"']
    y-axis "Blocked Domains"
    bar [10021, 8752, 3326, 701, 699, 578, 508, 458, 424, 264]
```
...
xychart-beta
    ...
    y-axis "Blocked Domains"
    bar [4820, 4536, 4472, 2720, 2368, 1939, 1537, 1357, 841, 765]
```
...
*Auto-generated · `2026-02-20 17:12:23` · [sync_blocklist.py](./sync_blocklist.py)*
