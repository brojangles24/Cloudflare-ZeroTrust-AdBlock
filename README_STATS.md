...
![Last Sync](https://img.shields.io/badge/Last_Sync-2026-02-21_16-36-56-blue?style=for-the-badge&logo=cloudflare&logoColor=white)
...
![Runtime](https://img.shields.io/badge/Runtime-65.95s-lightgrey?style=for-the-badge&logo=lightning&logoColor=white)
...
| ⏱️ | **Sync Runtime** | `65.95s` | wall clock |
...
xychart-beta horizontal
    ...
    y-axis "Domains"
    bar [186, 13758, 34405, 10291, 196863]
    line [186, 13758, 34405, 10291, 196863]
```
...
xychart-beta
    ...
    x-axis ['"sex"', '"porn"', '"xxx"', '"hentai"', '"xnxx"', '"fuck"', '"milf"', '"erotic"', '"bdsm"', '"pussy"']
    y-axis "Blocked Domains"
    bar [10900, 9544, 2974, 701, 684, 523, 502, 440, 279, 256]
```
...
*Auto-generated · `2026-02-21 16:36:56` · [sync_blocklist.py](./sync_blocklist.py)*
